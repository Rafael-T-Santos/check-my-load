...
export function OrderPhotoModal({ orderId, customerName, isOpen, photos, onClose, onAddPhoto }: OrderPhotoModalProps) {
          ...
          >
            ...
            <div className="bg-card p-4 border-b flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold">Fotos do Pedido</h2>
                ...
                <>
                  ...
                  {photos.length === 0 ? (
                    <div className="flex flex-col items-center gap-2 py-10 text-center text-muted-foreground">
                      ...
                      <p className="text-sm">Nenhuma foto registrada para este pedido</p>
                    </div>
                  ) : (
                    <div className="space-y-3">
